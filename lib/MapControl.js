...
var MapControl = function (_Component) {
  ...
  _createClass(MapControl, [{
    ...
    value: function getMap() {
      process.env.NODE_ENV !== 'production' ? warning(this.props.map && !this.context.map, 'Passing map as a prop is deprecated. Please check the change log for more information.') : void 0;
      return this.context.map || this.props.map;
    }
  }, {
    key: 'getLayerContainer',
    value: function getLayerContainer() {
      process.env.NODE_ENV !== 'production' ? warning(this.props.layerContainer && !this.context.layerContainer, 'Passing layerContainer as a prop is deprecated. Please check the change log for more information.') : void 0;
